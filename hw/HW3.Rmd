...
cat("Likelihood Ratio Test For Additional Parameters\n")
cat(round(pchisq(-2 * (-runOPT$value + updateOPT$value), 2, lower.tail=F), 4))

cat("\nAIC Calculations for models\n")
print(c(
    Baseline = round(2*(length(runOPT$par)) + 2 * runOPT$value, 4), 
